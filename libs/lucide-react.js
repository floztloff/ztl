// lucide-react proxy — no requires
(function() {
  ...
  function Poly(points) { return React.createElement('polyline', { points: points }); }
  function Rect(x, y, w, h, rx, ry) { return React.createElement('rect', { x, y, width: w, height: h, rx, ry }); }
