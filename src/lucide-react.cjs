...
function icon(paths) {
  return function(props) {
    ...
    if (props) { for (var k in props) attrs[k] = props[k]; }
    var kids = paths.map(function(d) { return React.createElement('path', { d: d }); });
    return React.createElement.apply(null, ['svg', attrs].concat(kids));
  };
}
