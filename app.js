  ...
  var require_lucide_react = __commonJS({
    "src/lucide-react.cjs"(exports, module) {
      ...
      module.exports = {
        ...
        Clock: (p) => Svg(p, C2(12, 12, 10), Poly("12 6 12 12 16 14")),
        ...
        Camera: (p) => Svg(p, P("M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"), C2(12, 13, 4)),
        Calendar: (p) => Svg(p, Rect(3, 4, 18, 18, 2), L(16, 2, 16, 6), L(8, 2, 8, 6), L(3, 10, 21, 10)),
        ShoppingCart: (p) => Svg(p, C2(9, 20, 1), C2(20, 20, 1), P("M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6")),
        ...
        Sun: (p) => Svg(p, C2(12, 12, 5), L(12, 1, 12, 3), L(12, 21, 12, 23), L(4.22, 4.22, 5.64, 5.64), L(1.41, 1.41, 5.64, 5.64), L(1, 12, 3, 12), L(21, 12, 23, 12), L(4.22, 17.78, 5.64, 16.36), L(18.36, 5.64, 19.78, 4.22)),
        ...
        CloudSnow: (p) => Svg(p, P("M17.5 19H9a5 5 0 1 1 4.9-6.2A3.5 3.5 0 1 1 17.5 19Z"), C2(12, 21, 1), C2(8, 20, 1), C2(16, 20, 1)),
...
${lines.join("\n")}`;
  ...
  function wmoInfo(code) {
    ...
    if (code === 1 || code === 2) return { Icon: import_lucide_react.CloudSun, label: "\xC9claircies", color: C.amber };
    if (code === 3) return { Icon: import_lucide_react.Cloud, label: "Couvert", color: C.mut };
    if (code === 45 || code === 48) return { Icon: import_lucide_react.CloudFog, label: "Brouillard", color: C.mut };
    if (code >= 51 && code <= 57) return { Icon: import_lucide_react.CloudDrizzle, label: "Bruine", color: C.teal };
    if (code >= 61 && code <= 67 || code >= 80 && code <= 82) return { Icon: import_lucide_react.CloudRain, label: "Pluie", color: C.teal };
    if (code >= 71 && code <= 77 || code === 85 || code === 86) return { Icon: import_lucide_react.CloudSnow, label: "Neige", color: C.teal };
    if (code >= 95) return { Icon: import_lucide_react.CloudLightning, label: "Orage", color: C.ember };
    return { Icon: import_lucide_react.CloudSun, label: "\u2014", color: C.mut };
  }
  function Weather() {
